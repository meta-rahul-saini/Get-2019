...
/**
 * this servlet handles the show all data request and dynamically generates HTML web page response
 */
...
public class ShowAllStudentServlet extends HttpServlet 
{
	...
	protected void doGet(HttpServletRequest request,
		...
		try {
			...
			// generating dynamic web page response
			...
			while (rs.next()) {
				...
				out.println("<td> <a href=\"UpdateStudentServlet?id="+rs.getString(1)+"\" >update </a></td");
				out.println("</tr>");
			}
